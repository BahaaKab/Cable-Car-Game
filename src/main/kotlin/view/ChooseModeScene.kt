...
class ChooseModeScene(private val rootService: RootService) : MenuScene(1920, 1080), Refreshable {
    ...
    private val chooseModeLabel: Label = Label(
        ...
        font = Font(
            size = 20, color = Color(5, 24, 156), fontWeight = Font.FontWeight.SEMI_BOLD, family = DEFAULT_FONT_MEDIUM
        ),
    ...
    private val localButton: Button = Button(
        ...
        onMouseClicked = {
            CableCarApplication.showMenuScene(CableCarApplication.localLobbyScene)
        }
    }
